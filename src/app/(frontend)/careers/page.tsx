...
/* Revalidated every five minutes so a role published in the admin appears here
   ...
   rendered from the source-document copy. */
...
const ROLES = [
  {
    key: 'data-engineer',
    art: '/img/de-warehouse.svg',
    alt: 'Abstract layered cloud warehouse storage',
  ...
  {
    key: 'ai-engineer',
    art: '/img/ai-agent.svg',
    alt: 'Abstract multi-step AI workflow with a human approval gate',
  ...
  },
  {
    ...
    alt: 'Abstract radar sweep resolving scattered data points',
  ...
  {
    key: 'science-bi',
    art: '/img/as-matrix.svg',
    alt: 'Abstract impact-versus-effort scatter used to prioritise work',
...
// Synchronous again. The one database-backed section lives in <JobOpenings />
// behind its own Suspense boundary, so this page renders from the source
// documents without waiting on Neon.
    ...
    <>
      ...
      <section className="band">
        <div className="wrap">
          ...
          <div className="feature feature--copy">
            ...
            <Figure src="/img/cr-team.svg" alt="Abstract diagram of one person's work connected into a wider engagement" />
          </div>
        </div>
      </section>
      ...
      <section className="band band--tint" id="open-roles">
        <div className="wrap">
          ...
          <div className="rv">
            <Scroller
              label="Open role tracks"
              items={ROLES.map((r) => ({
                key: r.key,
                node: (
                  <article className="card" style={{ height: '100%' }}>
                    <div className="card__art">
                      <img src={r.art} alt={r.alt} width={800} height={520} loading="lazy" decoding="async" />
                    </div>
                    <h3 className="h-sm">{r.h}</h3>
                    {r.paras.map((t, i) => (
                      <p key={i}>{t}</p>
                    ))}
                    <p>
      ...
      {/* Live openings stream in behind a Suspense boundary; everything above and
          below renders immediately from the source documents. */}
      <JobOpenings />
          ...
          <div className="feature">
            <div className="rv rv--left">
              ...
              <p className="lede">
                ...
                the role while allowing the Cognovea team to assess the experience and technical approach relevant to
                the position.
              </p>
            </div>
