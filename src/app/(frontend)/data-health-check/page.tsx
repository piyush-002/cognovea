...
export default function DataHealthCheckPage() {
  return (
    <>
      ...
      {/* Placed immediately before the booking form, which is the moment a
          reader decides. Prefers a quote tagged "Data Health Check"; if none is
          published, nothing renders and the page is unchanged. */}
      <Testimonial service="data-health-check" />
